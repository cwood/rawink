...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Order.tattooee'
        db.delete_column('orders_order', 'tattooee')

        # Adding field 'Order.date_for_tattoo'
        db.add_column('orders_order', 'date_for_tattoo', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Order.tattooee'
        db.add_column('orders_order', 'tattooee', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Deleting field 'Order.date_for_tattoo'
        db.delete_column('orders_order', 'date_for_tattoo')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 24, 10, 1, 16, 38507)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 24, 10, 1, 16, 38426)'}),
