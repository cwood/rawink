...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('artists_artist', 'photo', self.gf('django.db.models.fields.files.ImageField')(default=1, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.photo'
        db.delete_column('artists_artist', 'photo')
