...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.title'
        db.add_column('artists_artist', 'title', self.gf('django.db.models.fields.TextField')(default='artist'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.title'
        db.delete_column('artists_artist', 'title')
